...
\title{Understanding Human Mobility From Semantic Twitter User Trajectories}

\author[1,*]{Junjun Yin}
\author[1]{xx}
%\author[1,2,+]{Christine Author}
%\author[2,+]{Derek Author}
\affil[1]{CyberGIS Center for Advanced Digital and Spatial Studies}
\affil[ ]{Department of Geography and Geographic Information Science}
