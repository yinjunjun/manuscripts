...
%DIF DEL Twitter_MovementPatterns_VisualAnalytics.tex      Wed Aug 17 22:55:30 2016
%DIF ADD Twitter_MovementPatterns_VisualAnalytics_v2.tex   Fri Sep  9 00:32:58 2016
...
\cite{padmanabhan2014flumapper}}%DIFAUXCMD
.
}\DIFaddend 
...
It \DIFdelbegin \DIFdel{delivers scalability }\DIFdelend \DIFaddbegin \DIFadd{provides efficiency }\DIFaddend in filtering large volume of geo-located tweets, modeling and extracting Twitter user movements, generating space-time user trajectories, and summarizing multi-level spatiotemporal user mobility patterns.
...
Finally, it is worth noting that \DIFaddbegin \DIFadd{at the current stage }\DIFaddend the geo-located Twitter data is not able to generalize to the entire population.
...
Nevertheless, \DIFaddbegin \DIFadd{the Twitter user movements provide clear supports to reveal the distance decay effects in human mobility research, which is observed in multiple spatial and temporal scales.
