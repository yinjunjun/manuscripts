...
%NOTE: I'm not sure how twitter relates to urban structure...

%NOTE: I did not review the figures or figure captions
...
\section*{Conclusion}
In this study, we delineated the non-administrative anthropographic urban boundaries within the United Kingdom using a network of Twitter user spatial interactions inferred from the collective Twitter user movement data extracted from more than 69 million Twitter messages.
...
Identifying the connected regions at each of these distance ranges yielded hierarchical boundaries of  the urban space in the United Kingdom.
