...
%DIF ADD Paper.tex      Wed Oct 12 14:11:43 2016
...
\DIFaddbegin \DIFadd{To help readers that are not familiar with the geographic context in Great Britain better interpret the derived boundaries,
we had added two additional layers (i.e., locations of airport fields and population-wighted-centroids of workplace zones in the Great Britain) in the background of the figures.
