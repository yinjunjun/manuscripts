...
\Author{Junjun Yin $^{1,2}$, Shaowen Wang $^{1,2,3}$ and Zhenhong Du $^{4,*}$}
% Authors, for metadata in PDF
\AuthorNames{Junjun Yin, Shaowen Wang and Zhenhong Du}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad CyberGIS Center for Advanced Digital and Spatial Studies, University of Illinois at Urbana-Champaign, Urbana, IL 61801, USA\\
$^{2}$ \quad Department of Geography and Geographic Information Science, University of Illinois at Urbana-Champaign, Urbana, IL 61801, USA; jyn@illinois.edu\\
$^{3}$ \quad National Center for Supercomputing Applications, University of Illinois at Urbana-Champaign, Urbana, IL 61801, USA; shaowen@illinois.edu\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{Shaowen Wang conceived and designed the experiments; Junjun Yin and Zhenhong Du analyzed the results; Junjun Yin, Shaowen Wang and Zhenhong Du wrote the paper.}
