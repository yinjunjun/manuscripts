...
\Author{Junjun Yin $^{1,2}$ and Zhenhong Du $^{1,3,}$*}
% Authors, for metadata in PDF
\AuthorNames{Junjun Yin and Zhenhong Du}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad CyberGIS Center for Advanced Digital and Spatial Studies\\
...
$^{3}$ \quad Key Laboratory of Geographic Information Science, School of Earth Sciences, Zhejiang University, Hangzhou, 310028, China; duzhenhong@zju.edu.cn}
