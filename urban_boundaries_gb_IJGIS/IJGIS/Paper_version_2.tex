...
The demographic information of the Twitter users cannot be easily identified, the result of delineated urban boundaries may not reflect a complete real-world image from human movements.
...
Nevertheless, since this study focus on the connections made through Twitter user movements between urban regions, we visualized the mobility flux of Twitter user movements using the method mentioned in~\citep{rae2009}(see Supplement Materials section 1). The outcome showed that the Twitter user movements in this study connect most urban areas in Great Britain and clearly exhibited long and short distance movements. In this connection, geo-located Twitter data demonstrated its applicability for this study, along with the large spatial coverage and easy data accessibility as mentioned above.  
In addition, 
