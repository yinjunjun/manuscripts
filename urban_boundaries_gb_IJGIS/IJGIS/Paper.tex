...
\begin{center}
<<<<<<< Updated upstream
\includegraphics[width=0.8\linewidth]{./figure/usa}
\caption{\bfseries{Each point corresponds to a geo-located tweet collected for this study. Twitter activity is most apparent in urban areas.}}
=======
\includegraphics[width=0.6\linewidth]{./figure/usa}
