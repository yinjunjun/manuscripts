...
While government agencies define various sets of boundaries to partition the geographical space into  
However, the spatial extent of these defined unit    

Although, their physical boundaries can be adjacent or distant, based on various connections amongst themselves, such as social-economic relations and commute patterns of citizens, certain groups of urban regions are more strongly connected as clusters than others. 
