...
\title{{\itshape The geography of urban boundaries in Great Britain from the network of Twitter user spatial interactions} }
\maketitle
...
In this study, we describe a novel approach to delineating urban boundaries based on the actual movements (i.e., the reallocation in space) of 
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.8\linewidth]{./figure/uk}
\caption{{\bf The spatial coverage of collected geo-located Twitter messages in Great Britain.} Each point corresponds to a geo-located tweet collected for this study. Twitter activity is most apparent in urban areas.}
\label{S2_Fig}
\end{center}
\end{figure}
