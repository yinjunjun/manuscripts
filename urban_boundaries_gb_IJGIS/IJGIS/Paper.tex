...
\citep{vasardani2013}
\citep{hollenstein2010}
\citep{stefanidis2013}



For example, empirical studies have utilized 
Connections are made among these units with various human activities crossing the boarders, such as social-economic relations and commute patterns of citizens. 
In such cases, certain groups of units are more strongly connected as clusters than others, and the boarders of agglomeration of these units
how people naturally interact with the space can be in grate importance for decision makers regarding city planning, resource allocation and even marketing campaigns. 
