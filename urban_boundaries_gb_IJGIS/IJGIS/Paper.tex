...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=1.0\linewidth]{./figure/uk}
\caption{{\bf The spatial coverage of collected geo-located Twitter messages in Great Britain (left) and London (right).} Each point corresponds to a geo-located tweet collected for this study. Twitter activity is most apparent in urban areas.}
\label{S2_Fig}
\end{center}
\end{figure}
