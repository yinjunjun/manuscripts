...
To avoid deciding the cell size arbitrarily, we studied the probability distributions of the radius of gyrations of individual Twitters users and selected 10-km as the cell size, which is the distinct geographic distance for separating two main groups of Twitter users in terms of the spatial coverage at the national level.
In addition, this choice allows us to focus on the inter-connections among different urban regions with less attention to movements around a user's neighborhood (i.e., within 10 km radius), such as home or work places.
